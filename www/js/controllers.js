...
.controller('AccountController', ["AccountService", "$state", "$rootScope", "$ionicLoading", "$ionicPopup", function(AccountService, $state, $rootScope, $ionicLoading, $ionicPopup) {
  ...
  vm.login = function() {
    ...
    .then(function(user) {
      ...
      $ionicLoading.hide();
      errorHandler({
        title : "<h4 class='center-align'>Usuario o contraseña incorrecta!</h4>"
      })
    })
  }
  ...
  vm.signup = function() {
    ...
    .then(function(user) {
      ...
      errorHandler({
        title : "<h4 class='center-align'>El correo y la contraseña deben ser correctas</h4>"
      })
      $ionicLoading.hide();
    })
  }
